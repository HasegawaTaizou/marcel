...
const { isAlunoAprovado, verificarSexo } = require("./modulo/modulo-exercicio1.js");
            ...
            entradaDados.question('Digite o sexo do professor: ', function(sexo) {
                ...
                entradaDados.question('Digite o nome do curso: ', function(curso) {
                    ...
                    entradaDados.question('Digite o nome da disciplina: ', function(disciplina) {
                        ...
                        entradaDados.question('Digite a primeira nota de 0 a 100: ', function(nota1) {
                            let primeiraNota = nota1

                            entradaDados.question('Digite a segunda nota de 0 a 100: ', function(nota2) {
                                let segundaNota = nota2

                                entradaDados.question('Digite a terceira nota de 0 a 100: ', function(nota3) {
                                    let terceiraNota = nota3

                                    entradaDados.question('Digite a quarta nota de 0 a 100: ', function(nota4) {
                                        let quartaNota = nota4
                                        moduloExercicio1.isAlunoAprovado(primeiraNota, segundaNota, terceiraNota, quartaNota)
                                        // moduloExercicio1.fazerRecuper
                                            moduloExercicio1.mostrarRelatorio(nomeAluno, nomeProfessor, sexoAluno, sexoProfessor, nomeCurso, nomeDisciplina, primeiraNota, segundaNota, terceiraNota, quartaNota)
